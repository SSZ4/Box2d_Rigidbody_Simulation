...
void CreateGround(float x1, float y1, float x2, float y2);
...
void Render()
{
	...
	CreateGround(-50.0f, -68.0f, 520.0f, -68.0f); //배경윗줄
	CreateGround(-50.0f, 68.0f, 520.0f, 68.0f); //배경아랫줄
	CreateGround(-46.0f, -68.0f, -46.0f, 68.0f); //배경왼쪽줄	
	CreateGround(520.0f, -68.0f, 520.0f, 68.0f); //배경오른쪽줄	
...
void Setup() {
	...
	SetupBoxbddy(109.0f, -7.0f, 2.0f, 2.0f, 0.0f, 41);			   				 
	SetupBoxbddy(109.0f, -15.0f, 2.0f, 2.0f, 0.0f, 15);
	SetupBoxbddy(109.0f, -23.0f, 2.0f, 2.0f, 0.0f, 16);
	SetupBoxbddy(109.0f, -31.0f, 2.0f, 2.0f, 0.0f, 17);
	SetupBoxbddy(109.0f, -39.0f, 2.0f, 2.0f, 0.0f, 18);
	SetupBoxbddy(109.0f, -47.0f, 2.0f, 2.0f, 0.0f, 19);
	SetupBoxbddy(109.0f, -55.0f, 2.0f, 2.0f, 0.0f, 20);
	...
	SetupBoxbdst(513.0f, -41.3f, 6.0f, 27.0f, 0.0f, 37);
...
void CreateGround(float x1, float y1, float x2, float y2) {
	...
	gnd_shape.Set(b2Vec2(x1, y1), b2Vec2(x2, y2));
